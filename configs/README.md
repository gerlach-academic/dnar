...
Most algorithms seem to learn fine with lr=1e-4, but mst, bfs, a_star seem to benefit from larger learning rates early, but seems to settle into slightly worse minima later on.
